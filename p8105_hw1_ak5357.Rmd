...
This explains what happens when we pass numeric, logical, or character arrays into the `mean()` function. However, in my opinion, it does not explain why we receive a `NA` value when passing an array of factors to the `mean()` function.
